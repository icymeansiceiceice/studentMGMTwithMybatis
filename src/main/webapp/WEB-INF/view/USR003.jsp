...
<head>
        ...
        <link rel="stylesheet" href="/stubatis/reach/test/test.css">
...
<body>
    ...
    <div class="sidenav">
        ...
        <a href="/stubatis/UserShow">Users Management</a>
      </div>
      
      <div class="main_contents">
    <div id="sub_content">
    <p style="color: red;">${param.notfound }</p>
    	<form:form class="row g-3 mt-3 ms-2" action="/stubatis/processingUsearch" method="post" modelAttribute="user">
            ...
            <div class="col-auto">
                <button type="button" class="btn btn-secondary " onclick="location.href = '/stubatis/URegister';">
                    Add
                </button>
        ...
        <table class="table table-striped" id="stduentTable">
            ...
            <c:forEach var="u" items="${sessionScope.user}">
                ...
                <td>
                    <button type="button" class="btn btn-success  " onclick="location.href = '/stubatis/updateUser/${u.id}';">
                        Update
                    </button>
                </td>
                <td>
                <a href="/stubatis/deleteUser/${u.id}">
