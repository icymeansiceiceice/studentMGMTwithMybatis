...
<body>
  <div id="testheader">
    ...
    <div id="sub_content">
    <form:form class="row g-3 mt-3 ms-2"  action="/stubatis/StudentSearch" method="post" modelAttribute="stu"> 
      ...
      <table class="table table-striped" id="stduentTable">
        ...
        <c:forEach var="s" items="${sessionScope.student}">
          <tr>
            ...
            <td>
              <a href="/stubatis/StudentUpdate/${s.id }"><button type="button" class="btn btn-secondary mb-2" >See More</button></a>
